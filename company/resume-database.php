      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <p>In this section you can download resume of all students who applied to your Internship posts</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                       $sql = "SELECT users.* FROM intern_post INNER JOIN apply_intern_post ON intern_post.id_internpost=apply_intern_post.id_internpost  INNER JOIN users ON users.id_user=apply_intern_post.id_user WHERE apply_intern_post.id_company='$_SESSION[id_company]' GROUP BY users.id_user";
