      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
             $sql = "SELECT * FROM intern_post INNER JOIN apply_intern_post ON intern_post.id_internpost=apply_intern_post.id_internpost  INNER JOIN users ON users.id_user=apply_intern_post.id_user WHERE apply_intern_post.id_company='$_SESSION[id_company]'";
            ...
            <div class="attachment-block clearfix padding-2">
                <h4 class="attachment-heading"><a href="user-application.php?id=<?php echo $row['id_user']; ?>&id_internpost=<?php echo $row['id_internpost']; ?>"><?php echo $row['interntitle'].' @ ('.$row['firstname'].' '.$row['lastname'].')'; ?></a></h4>
                <div class="attachment-text padding-2">
                  ...
                  if($row['status'] == 0) {
                    ...
                    echo '<div class="pull-right"><strong class="text-green">Accept</strong></div> ';
                  }
                  ?>
