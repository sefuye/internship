        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <i class="icon fa fa-info"></i> In this dashboard you are able to change your account settings, post and manage your Internship. Got a question? Do not hesitate to drop us a mail.
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Internship Posted</span>
                    <?php
                    $sql = "SELECT * FROM intern_post WHERE id_company='$_SESSION[id_company]'";
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Application For Internship</span>
                    <?php
                    $sql = "SELECT * FROM apply_intern_post WHERE id_company='$_SESSION[id_company]'";
                    $result = $conn->query($sql);
