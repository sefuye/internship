...
<div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>My Internship Posts</i></h2>
            <p>In this section you can view all internship posts created by you.</p>
                    ...
                    <?php
                     $sql = "SELECT * FROM intern_post WHERE id_company='$_SESSION[id_company]'";
                      ...
                      <tr>
                        ...
                        <td><a href="view-internship-post.php?id=<?php echo $row['id_internpost']; ?>"><i class="fa fa-address-card-o"></i></a></td>
                      </tr>
                      <?php
                       }
                     }
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; WBIA <a href="jonsnow.netai.net">WBIA</a>.</strong> All rights
    reserved.
    </div>
  </footer>
