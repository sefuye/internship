      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="active-interns.php"><i class="fa fa-briefcase"></i> Active Internship</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3>Internship System Statistics</h3>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Total Internship Posts</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    ...
                    <?php
                      $sql = "SELECT * FROM apply_intern_post";
                      $result = $conn->query($sql);
                      if($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
