...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Internship</b> System</span>
    </a>
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="../interns.php"><i class="fa fa-list-ul"></i> Internship</a></li>
            ...
            ?>
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <label for="stream">Departments/Stream</label>
                    <input type="text" class="form-control input-lg" id="department or stream" name="stream" placeholder="stream" value="<?php echo $row['stream']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Skills</label>
