...
$sql = "SELECT * FROM apply_intern_post WHERE id_user='$_SESSION[id_user]' AND id_internpost='$_GET[id]'";
$result = $conn->query($sql);
if($result->num_rows > 0) 
{
  
  $sql1 = "SELECT * FROM intern_post INNER JOIN company ON intern_post.id_company=company.id_company WHERE id_internpost='$_GET[id]'";
