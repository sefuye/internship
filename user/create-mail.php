            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="../jobs.php"><i class="fa fa-list-ul"></i> Internship</a></li>
              ...
              <div class="box-body">
                <div class="form-group">
                  <select name="to" class="form-control">
                    <?php 
                    $sql = "SELECT * FROM apply_intern_post INNER JOIN company ON apply_intern_post.id_company=company.id_company WHERE apply_intern_post.id_user='$_SESSION[id_user]' AND apply_intern_post.status='2'";
