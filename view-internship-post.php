...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>WBIC</b> System</span>
    </a>
  ...
  <?php
    ...
    $sql = "SELECT * FROM intern_post INNER JOIN company ON intern_post.id_company=company.id_company WHERE id_internpost='$_GET[id]'";
        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <a href="interns.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
            </div>
            ...
            <div>
              <a href="apply.php?id=<?php echo $row['id_internpost']; ?>" class="btn btn-success btn-flat margin-top-50">Apply</a>
            </div>
            <?php } ?>
