    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
            <a href="interns.php">Internship</a>
          </li>
    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">Student Registration</h1>
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2022-12-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="age" name="age" placeholder="Age" readonly>
              </div>
              <div class="form-group">
                <label>Graduate End Date</label>
                <input class="form-control input-lg" type="date" id="passingyear" name="passingyear" placeholder="Passing Year">
              </div>     
              <div class="form-group">
              <select name="stream" id="stream" class="form-control input-lg">
                     <option value="Defualt">Select Your Department</option>
                     ...
                     <option value="Electronics Engineering">Electrical Engineering</option>
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
              <select id="skills" name="skills" class="form-control input-lg">
                     <option value="Defualt">Select Your University</option>
