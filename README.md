...
```bash
  git clone https://github.com/gshanbhag525/Job-System.git
```

import the git_repos_jobSystem.sql in the xampp mysql database.


Paste the job System code in htdocs folder. (found in WAMPP, XAMMP, MAMPP installation folder)
...
## Companies can register on this System as well as the candidates.
...
## These website use session cookies for proper account management and provides security for the System
